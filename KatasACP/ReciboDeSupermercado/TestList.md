Escribe un código que se pueda usar en un supermercado para calcular el costo total de los artículos en un carrito de compras y proporcionar
un recibo al cliente.

El supermercado tiene un catálogo con diferentes tipos de productos (arroz, manzanas, leche, cepillos de dientes,…). Cada producto tiene un precio,
y el precio total del carrito de compras es la suma de todos los precios de los artículos. Recibes un recibo que detalla los artículos que has comprado,
el precio total y cualquier descuento que se haya aplicado.

El supermercado tiene ofertas especiales, por ejemplo:

Compra dos cepillos de dientes y llévate uno gratis. El precio normal del cepillo de dientes es de 0,99 €.
